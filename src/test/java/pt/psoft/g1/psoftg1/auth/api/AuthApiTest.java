...
class AuthApiTest {
    ...
    private final String password = "123456Test";

    @Autowired
    public AuthApiTest(final MockMvc mockMvc, final ObjectMapper objectMapper, final UserTestDataFactory userTestDataFactory) {
    ...
    void testLoginFail() throws Exception {
        final UserView userView = userTestDataFactory
                .createUser(String.format("test%d@test.test", currentTimeMillis()), "Test User", password);
